...
<body>
			...
			<div class="carousel-inner">
				...
				<div class="item active">
					...
					<div class="carousel-caption">
						...
						<h2>Bem-vindo a sua plataforma de consultas veiculares. </h2>

						<h4>A Auto Cred Car é a mais nova plataforma de consultas do Brasil. Seus profissionais possuem anos de experiência no mercado.  </h4>
				...
				<div class="item">
					...
					<div class="carousel-caption">
						...
						<h2>Empresa especializada em pesquisa de veículos.</h2>
						<h4>Todas as informações que você na compra do seu veiculo.</h4>
					</div>
				</div>
				<div class="item">
					...
					<div class="carousel-caption">
						...
						<h2>As nossa consultas são avaliadas por analista e peritos na área de veículos</h2>
						<h4>para que você tenha mais confiança e tranquilidade e conforto. Você pode confiar.</h4>
					</div>
				</div>
  ...
  <h2 id="explore" class="text-center title-consulta lazy">Nossas Consultas</h2>
          ...
          <div class="nbs-flexisel-container">
            <div class="nbs-flexisel-inner">
              <ul id="flexiselDemo1" class="nbs-flexisel-ul">
                  ...
                  <li>
        					<div class="col-md-3 divPrincipal lazy"  data-anijs="if: scroll, on: window, do: rollIn animated, before: $scrollReveal repeat">
        						<div class="card" >
        							<div class="col-md-4 col-xs-2" style="width:90px">
                                        <img src="images/autocompleta.svg" class="image-svg" alt=""></div>
        							<div class="col-md-8" >
				...
				<div class="row">
					<h2 class="text-center titulo">Consultas Crédito</h2>
				</div>
        <div class="principal" >
          <div class="nbs-flexisel-container">
            <div class="nbs-flexisel-inner">
...
<!-- 			<div class="ear-piece">
                ...
                <div class="contact-text lazy">
                    ...
                    <table class="lazy">
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td><h3><strong>Contato</strong> </h3></td>
                            <td><h3><strong>Matriz</strong></h3></td>
                            <td><h3><strong>Filial</strong></h3></td>
                        </tr>
                        <tr>
	...
	<footer id="footer">
        ...
        <div class="container lazy" style="text-align:center">
            	...
            	<img class="img_footer" src="img/parceiros/selo.png">

              <img class="img_footer" src="img/parceiros/selo2.png"   >
